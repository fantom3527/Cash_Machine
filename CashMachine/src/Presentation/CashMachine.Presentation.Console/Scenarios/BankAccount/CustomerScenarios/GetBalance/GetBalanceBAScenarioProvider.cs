...
{
    public class GetBalanceBAScenarioProvider : ICustomerScenarioProvider
    {
        ...
        public GetBalanceBAScenarioProvider(
        ...
        public bool TryGetScenario([NotNullWhen(true)] out IScenario? scenario)
        {
            ...
            scenario = new GetBalanceBAScenario(_service, _currentBankAccountManager);
            return true;
        }
    }
}
